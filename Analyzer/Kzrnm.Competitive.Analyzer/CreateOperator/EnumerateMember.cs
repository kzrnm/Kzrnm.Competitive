...
using Kzrnm.Competitive.Analyzer.CreateOperator.Specified;
...
internal class EnumerateMember
{
    ...
    protected EnumerateMember(SemanticModel semanticModel, ITypeSymbol typeSymbol, AnalyzerConfig config)
    {
    ...
    public static EnumerateMember Create(SemanticModel semanticModel, ITypeSymbol typeSymbol, AnalyzerConfig config) => typeSymbol.OriginalDefinition.ToDisplayString() switch
    {
        ...
        "AtCoder.Operators.IMinMaxValueOperator<T>" => new MinMaxValueEnumerateMember(semanticModel, typeSymbol, config),
