...
namespace AtCoder.DataStructure.String
{
    public static partial class StringLib
    {
        ...
        /// </remarks>
        private static int[] SuffixArrayStatic<T>(ReadOnlyMemory<T> m)
        {
            var s = m.Span;
            var n = m.Length;
        ...
        /// <para>計算量: O(|<paramref name="s"/>|)</para>
        /// </remarks>
        public static int[] SuffixArrayStatic(string s)
        {
            var n = s.Length;
        ...
        /// </remarks>
        public static int[] SuffixArrayStatic<T>(T[] s) => SuffixArrayStatic<T>(s.AsMemory());
        ...
        /// </remarks>
        public static int[] SuffixArrayStatic(int[] s, int upper)
        {
