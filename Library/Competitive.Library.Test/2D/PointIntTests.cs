...
public class PointIntTests
{
    ...
    public static IEnumerable<(Point, Point, int)> Inner_Data =>
    [
        (new (0,0), new (0,0), 0),
        (new (0,1), new (1,0), 0),
        (new (5,1), new (-2,10), 0),
    ...
    public async Task Inner(Point p1, Point p2, int expected)
    {
        await p1.Inner(p2).Should().BeEqualTo(expected);
    }

    public static IEnumerable<(Point, Point, int)> Cross_Data =>
    [
        (new (0,0), new (0,0), 0),
        (new (0,1), new (1,0), -1),
        (new (5,1), new (-2,10), 52),
    ...
    public async Task Cross(Point p1, Point p2, int expected)
    {
