...
namespace Kzrnm.Competitive.Testing.MathNS.Matrix
{
    public class BitMatrixTests
    {
        ...
        public void Add(BitMatrix mat1, BitMatrix mat2, BitMatrix expected)
        {
            ...
            default(BitMatrix.Operator).Add(mat1, mat2).Should().BeEquivalentTo(expected);
            default(BitMatrix.Operator).Add(mat2, mat1).Should().BeEquivalentTo(expected);
            default(BitMatrix.Operator).Subtract(mat1, mat2).Should().BeEquivalentTo(expected);
#endif
        }
        ...
        public void Multiply(BitMatrix mat1, BitMatrix mat2, BitMatrix expected)
        {
            (mat1 * mat2).Should().BeEquivalentTo(expected);
#if !NET7_0_OR_GREATER
            default(BitMatrix.Operator).Multiply(mat1, mat2).Should().BeEquivalentTo(expected);
#endif
        }
