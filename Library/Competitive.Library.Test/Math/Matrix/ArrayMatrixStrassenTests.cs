...
public class ArrayMatrixStrassenTests
{
    ...
    [MethodDataSource(nameof(RandomStrassen_Data))]
    public async Task RandomStrassen(ArrayMatrix<byte> matInt1, ArrayMatrix<byte> matInt2)
    {
        ...
        await ModInt2Int(mat1.Strassen(mat2)).Should().BeEqualTo(expected);
    }

    [Test, MultipleAssertions]
    [Property("Category", "Operator")]
    public async Task LargeRandomStrassen()
    {
        var rnd = new Random(227);
