...
namespace Kzrnm.Competitive
{
    ...
    // competitive-verifier: TITLE Convex Hull Trick(Li-Chao (Segment) Tree): OperatorInterface
    /// <summary>
    ...
    /// </summary>
    public class LongMinConvexHullTrick : ConvexHullTrick<long, LongOperator, MinConvexHullTrickOperator<long>>
    {
        /// <summary>
        /// 使用する <paramref name="xs"/> の値を初期化します。<paramref name="xs"/> はソート済みであること。
        /// </summary>
    ...
    /// </summary>
    public class LongMaxConvexHullTrick : ConvexHullTrick<long, LongOperator, MaxConvexHullTrickOperator<long>>
    {
        /// <summary>
        /// 使用する <paramref name="xs"/> の値を初期化します。<paramref name="xs"/> はソート済みであること。
        /// </summary>
