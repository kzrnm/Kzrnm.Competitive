...
namespace Kzrnm.Competitive
{
    ...
    {
        /// <summary>
        /// <para><paramref name="s"/>[..i] と <paramref name="t"/>[..j] の LCS(最長共通部分列)長を table[i][j] に保持する2次元配列を返します。</para>
        ...
        /// <summary>
        /// <para><paramref name="s"/> と <paramref name="t"/> の LCS(最長共通部分列)を返します。</para>
        /// <para>計算量: O(|<paramref name="s"/>| |<paramref name="t"/>|)</para>
        /// </summary>
