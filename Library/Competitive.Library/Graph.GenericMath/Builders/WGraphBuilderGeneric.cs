...
namespace Kzrnm.Competitive
{
        ...
        where T : IAdditionOperators<T, T, T>
    {
        ...
        public WGraph<T, WGraphNode<T, WEdge<T, S>>, WEdge<T, S>> ToGraph()
            => GraphBuilderLogic.ToGraph<WGraph<T, WGraphNode<T, WEdge<T, S>>, WEdge<T, S>>, WGraphNode<T, WEdge<T, S>>, WEdge<T, S>, TBOp>(edgeContainer);

        public WTreeGraph<T, WTreeNode<T, WEdge<T, S>>, WEdge<T, S>> ToTree(int root = 0)
            => GraphBuilderLogic.ToTree<WTreeGraph<T, WTreeNode<T, WEdge<T, S>>, WEdge<T, S>>, WTreeNode<T, WEdge<T, S>>, WEdge<T, S>, TBOp>(edgeContainer, root);
        struct TBOp :
            IGraphBuildOperator<WGraph<T, WGraphNode<T, WEdge<T, S>>, WEdge<T, S>>, WGraphNode<T, WEdge<T, S>>, WEdge<T, S>>,
            ITreeBuildOperator<WTreeGraph<T, WTreeNode<T, WEdge<T, S>>, WEdge<T, S>>, WTreeNode<T, WEdge<T, S>>, WEdge<T, S>>
        {
            [凾(256)] public WGraph<T, WGraphNode<T, WEdge<T, S>>, WEdge<T, S>> Graph(WGraphNode<T, WEdge<T, S>>[] nodes, Csr<WEdge<T, S>> edges) => new WGraph<T, WGraphNode<T, WEdge<T, S>>, WEdge<T, S>>(nodes, edges);
            ...
            [凾(256)] public WTreeGraph<T, WTreeNode<T, WEdge<T, S>>, WEdge<T, S>> Tree(WTreeNode<T, WEdge<T, S>>[] nodes, int root, HeavyLightDecomposition<WTreeNode<T, WEdge<T, S>>, WEdge<T, S>> hl) => new WTreeGraph<T, WTreeNode<T, WEdge<T, S>>, WEdge<T, S>>(nodes, root, hl);
            [凾(256)]
            public WTreeNode<T, WEdge<T, S>> TreeNode(int i, int size, WTreeNode<T, WEdge<T, S>> parent, WEdge<T, S> edge, WEdge<T, S>[] children)
                => new WTreeNode<T, WEdge<T, S>>(i, size, edge.Reversed(parent.Index), parent.Depth + 1, parent.DepthLength + edge.Value, children);
