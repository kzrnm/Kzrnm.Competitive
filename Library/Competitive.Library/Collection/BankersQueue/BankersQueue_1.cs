...
";
        ...
        /// </summary>
        private readonly IImmutableStack<T> _forwards;

        /// <summary>
        /// The size of <see cref="_backwards"/>.
        /// </summary>
        private readonly int _backwardsSize;

        /// <summary>
        /// The size of <see cref="_forwards"/>.
        /// </summary>
        private readonly int _forwardsSize;
        ...
        public bool IsEmpty
        {
            get
            {
                ...
                return _forwardsSize + _backwardsSize == 0;
            }
        }
        ...
        public BankersQueue<T> Enqueue(T value)
        {
            ...
            else if (_forwardsSize > _backwardsSize + 1)
            {
                return new BankersQueue<T>(_forwards, _forwardsSize, _backwards.Push(value), _backwardsSize + 1);
            }
            else
            {
                return new BankersQueue<T>(new LazyReverseStack(_forwards, _backwards.Push(value)), _forwardsSize + _backwardsSize + 1, ImmutableStack<T>.Empty, 0);
            }
        }
        ...
        public BankersQueue<T> Dequeue()
        {
            ...
            if (_forwardsSize > _backwardsSize + 1)
            {
                return new BankersQueue<T>(f, _forwardsSize - 1, _backwards, _backwardsSize);
            }
            else if (_backwardsSize == 0)
            {
                return BankersQueue<T>.Empty;
            }
            else
            {
                return new BankersQueue<T>(new LazyReverseStack(f, _backwards), _forwardsSize + _backwardsSize - 1, ImmutableStack<T>.Empty, 0);
            }
        }
