...
namespace Kzrnm.Competitive
{
    ...
    /// 遅延伝搬反転可能赤黒木
    /// </summary>
    public class LazyRedBlackTree<T> : LazyRedBlackTree<T, T, SingleRbstOp<T>>
    {
...
#pragma warning disable IDE0060 // 未使用のパラメーターを削除します
        public new T Prod(int l, int r) => throw new NotSupportedException();
        public new T Slice(int l, int length) => throw new NotSupportedException();
#pragma warning restore IDE0060 // 未使用のパラメーターを削除します
    ...
    public class LazyRedBlackTree<T, F, TOp> : IList<T>
