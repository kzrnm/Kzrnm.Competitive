...
namespace Kzrnm.Competitive
{
        ...
        where T : INumberBase<T>
    {
        ...
        [凾(256)] public ReadOnlySpan<T> AsSpan() => MemoryMarshal.CreateReadOnlySpan(ref Unsafe.As<Matrix6x6<T>, T>(ref Unsafe.AsRef(this)), 6 * 6);
        public T[][] ToArray() => new[]
        {
            new[]{ V00, V01, V02, V03, V04, V05 },
            new[]{ V10, V11, V12, V13, V14, V15 },
            new[]{ V20, V21, V22, V23, V24, V25 },
            new[]{ V30, V31, V32, V33, V34, V35 },
            new[]{ V40, V41, V42, V43, V44, V45 },
            new[]{ V50, V51, V52, V53, V54, V55 },
        };
        [凾(256)]
        public Matrix6x6(
