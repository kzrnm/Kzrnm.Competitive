...
namespace Kzrnm.Competitive
{
    ...
    public static partial class __MatrixProdStrassen
    {
        ...
        public readonly partial struct Impl<T> where T : struct, IStaticMod
        {
            ...
            public ArrayMatrix<StaticModInt<T>> Strassen(ArrayMatrix<StaticModInt<T>> mat1, ArrayMatrix<StaticModInt<T>> mat2)
            {
            ...
            [凾(256)]
            private ArrayMatrix<StaticModInt<T>> ToMatrix(VectorizedStaticModInt<T>[] c, int h, int w)
            {
            ...
            [凾(256 | 512)]
            private VectorizedStaticModInt<T>[] ToVectorize(ArrayMatrix<StaticModInt<T>> m)
            {
                var v = m.Value;
                var w = m.Width;
