...
namespace Kzrnm.Competitive
{
        ...
        where TOp : struct, IArithmeticOperator<T>
    {
        ...
        public static Matrix4x4<T, TOp> operator *(Matrix4x4<T, TOp> m, T x)
             => new Matrix4x4<T, TOp>(
                 (op.Multiply(x, m.Row0.Col0), op.Multiply(x, m.Row0.Col1), op.Multiply(x, m.Row0.Col2), op.Multiply(x, m.Row0.Col3)),
                 (op.Multiply(x, m.Row1.Col0), op.Multiply(x, m.Row1.Col1), op.Multiply(x, m.Row1.Col2), op.Multiply(x, m.Row1.Col3)),
                 (op.Multiply(x, m.Row2.Col0), op.Multiply(x, m.Row2.Col1), op.Multiply(x, m.Row2.Col2), op.Multiply(x, m.Row2.Col3)),
                 (op.Multiply(x, m.Row3.Col0), op.Multiply(x, m.Row3.Col1), op.Multiply(x, m.Row3.Col2), op.Multiply(x, m.Row3.Col3))
             );
